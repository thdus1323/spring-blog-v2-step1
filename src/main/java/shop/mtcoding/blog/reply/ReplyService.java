...
public class ReplyService {
    ...
    private final RelplyJPARepository relplyJPARepository;

    @Transactional
    public Reply 댓글쓰기(RelplyRequest.SaveDTO reqDTO, User sessionUser) {
        ...
        relplyJPARepository.save(reply);
    ...
    public void 댓글삭제(int replyId, int sessionUserId) {
        Reply reply = relplyJPARepository.findById(replyId)
        ...
        relplyJPARepository.deleteById(replyId);
    }
}